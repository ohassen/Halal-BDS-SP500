...
| [Anthropic API](https://www.anthropic.com) | BDS classification (Claude Opus 5.5 + web search) | Grounded, batched, re-screened quarterly. Has per-call cost; budget accordingly (~tens of $/quarter). |
...
| `BDS_MODEL` | `claude-opus-5-5` | Anthropic model id for the BDS classifier. Any current Claude model id works (e.g. a cheaper tier to reduce cost). |
