...
### BDS Compliance
Claude Opus 5.5 **with web search**, one grounded request per symbol via the Anthropic
...
4. **BDS check** — once per calendar quarter (Mar/Jun/Sep/Dec), classify via Claude Opus 5.5
